...
const FEATURES = [
  { title: "Luxury Design", subtitle: "Websites" },
  { title: "Custom UI/UX", subtitle: "Development" },
] as const;
        ...
        {SOCIALS.map((social, i) => (
          <li key={i}>
            <button
              ...
              className="relative inline-flex size-8 items-center justify-center overflow-clip rounded-full border border-solid border-[#999] bg-white/5 p-2 shadow-[0_0_0_1.5px_rgba(0,0,0,0.25),0_6px_12px_0_rgba(0,0,0,0.2)] touch-manipulation cursor-pointer transition-opacity duration-200 ease before:absolute before:inset-[-6px] before:content-[''] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white [-webkit-tap-highlight-color:transparent] [@media(hover:hover)_and_(pointer:fine)]:hover:opacity-80"
              style={{
                backgroundImage:
