  ...
  return (
    <>
      ...
      <section className="md:hidden min-h-[100dvh] flex flex-col justify-between items-center px-4 sm:px-6 pt-3 pb-5 bg-[#0C0C0C] select-none relative overflow-x-hidden text-center">
        ...
        {/* 2. Mobile Typography ("HI, I'M CHRIS") with Text Roll Hover (z-20) */}
        <FadeIn delay={0.12} y={15} className="w-full my-1 flex justify-center items-center z-20">
        ...
        {/* 3. Mobile 3D Character Model Container (z-30) */}
        <div className="relative w-full flex flex-col items-center justify-center my-1 sm:my-2 z-30 pointer-events-none">
          {/* Subtle Mobile Glow behind head (z-10) */}
          <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[310px] sm:w-[390px] h-[310px] sm:h-[390px] rounded-full bg-white/[0.045] blur-[70px] pointer-events-none z-10" />

          <FadeIn delay={0.25} y={15} className="z-30 relative">
            <motion.div
              animate={{ y: [0, -3, 0] }}
        ...
        {/* 4. Short Introduction Text & 5. Contact Me Button (z-40) */}
        <div className="flex flex-col items-center gap-3.5 w-full my-1 sm:my-2 z-40">
        ...
        {/* 6. Mobile Scroll Indicator (z-40) */}
        <FadeIn delay={0.55} y={10} className="mt-1 opacity-70 z-40">
      ...
      <section className="hidden md:flex h-screen flex-col justify-between overflow-visible relative bg-[#0C0C0C] select-none">
        ...
        {/* 1. Background Glow Layer (z-10) */}
        <div className="absolute left-1/2 top-[42%] -translate-x-1/2 -translate-y-1/2 w-[340px] sm:w-[460px] h-[340px] sm:h-[460px] rounded-full bg-white/[0.04] blur-[85px] pointer-events-none z-10" />

        {/* 2. Second Layer: Hero Typography with Text Roll (z-20) */}
        <div className="w-full overflow-hidden text-center z-20 flex justify-center items-center pt-2 sm:pt-4 md:pt-6 pointer-events-auto">
        ...
        {/* 3. Third Layer (Highest Content Layer): Alpha Transparent 3D Character (z-30, In Front of z-20 Text) */}
        <div className="absolute left-1/2 -translate-x-1/2 z-30 w-[320px] sm:w-[410px] md:w-[500px] lg:w-[570px] bottom-0 sm:bottom-2 pointer-events-none overflow-visible bg-transparent">
          <FadeIn delay={0.3} y={15}>
            <motion.div
              ...
              className="relative w-full flex flex-col items-center bg-transparent overflow-visible pointer-events-none"
            >
              <img
                src="/hero-character.png"
        ...
        {/* 4. Fourth Layer: Bottom Bar & CTA Content (z-40) */}
